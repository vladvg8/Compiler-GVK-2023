...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(115, "При добавлении лексемы был превышен максимальный размер таблицы лексем(-LT)"),
		ERROR_ENTRY(116, "Превышен размер таблицы идентификаторов(-IT)"),
		ERROR_ENTRY(117, "При добавлении инентификатора был превышен максимальный размер таблицы идентификаторов(IT)"),
		...
		ERROR_ENTRY(125, "Имя идентификатора превышает максимальное количество символов (25)"),
		ERROR_ENTRY(126, "Тип ковычек отличается друг от друга."),
